...
> = {
  "hybrid-maize": {
    ...
    products: [
      ...
      },
      {
        ...
        name: "SHAURYA-456",
        variety: "Hybrid Maize",
        description: "High yield potential hybrid corn seed with excellent grain quality. Strong plant structure with wider adaptability across diverse agro-climatic conditions.",
        features: ["High Yield", "Strong Structure", "Wide Adaptability"],
        season: "Kharif & Rabi",
        duration: "Kharif 110-115, Rabi 115-120 days",
      },
      {
        ...
        name: "SINDOOR-666",
        variety: "Hybrid Maize",
        description: "Premium hybrid corn seed with vibrant orange grain colour. Excellent yield potential with compact grain filling and erect canopy structure.",
        features: ["High Yield", "Compact Filling", "Erect Canopy"],
        season: "Kharif & Rabi",
        duration: "Kharif 110-115, Rabi 115-120 days",
      },
      {
        ...
        name: "SPYDER-777",
        variety: "Hybrid Maize",
        description: "Unrivaled hybrid corn seed with superior yield potential. Tall plants with excellent grain quality and biotic stress tolerance.",
        features: ["Superior Yield", "Biotic Stress Tolerant", "Tall Plants"],
        season: "Kharif & Rabi",
        duration: "Kharif 110-115, Rabi 115-120 days",
      },
      {
        id: 16,
        name: "GAME CHANGER-2025",
        variety: "Hybrid Maize",
        description: "Latest unrivaled hybrid corn seed with breakthrough yield potential. Strong plant architecture with excellent adaptability and stress tolerance.",
        features: ["Breakthrough Yield", "Strong Architecture", "Stress Tolerant"],
        season: "Kharif & Rabi",
        duration: "Kharif 110-115, Rabi 120-125 days",
      },
      {
        ...
        name: "CHANUKYA-222",
        variety: "Hybrid Maize",
        description: "Premium hybrid corn seed with excellent grain quality and compact filling. Wide adaptability with erect canopy and biotic stress tolerance.",
        features: ["Premium Quality", "Wide Adaptability", "Erect Canopy"],
        season: "Kharif & Rabi",
        duration: "Kharif 110-115, Rabi 115-120 days",
      },
      {
        ...
        name: "VISHNU-777",
        variety: "Hybrid Maize",
        description: "High-performance hybrid corn seed with excellent yield. Strong plant structure with erect canopy and wider adaptability for diverse conditions.",
        features: ["High Performance", "Erect Canopy", "Wide Adaptability"],
        season: "Kharif & Rabi",
        duration: "Kharif 110-115, Rabi 115-120 days",
      },
      {
        ...
        name: "SARDAAR-3636",
        variety: "Hybrid Maize",
        description: "High yield potential hybrid corn seed with excellent grain quality. Strong plant structure with erect canopy and wide adaptability for diverse conditions.",
        features: ["High Yield", "Wide Adaptability", "Erect Canopy"],
        season: "Kharif & Rabi",
        duration: "Kharif 110-115, Rabi 115-120 days",
      },
      {
  ...
  "hybrid-paddy": {
    ...
    products: [
      ...
      },
      {
        ...
        description: "High yield hybrid paddy with excellent grain quality. Medium plant height with strong tillers and good disease tolerance.",
        features: ["High Yield", "Strong Tillers", "Disease Tolerant"],
        season: "Kharif",
      ...
      },
      {
        ...
        name: "YAGNA-888",
        variety: "Hybrid Paddy",
        description: "Premium hybrid paddy seed with high yield potential. Strong plant architecture with excellent grain filling and disease tolerance.",
      ...
      },
      {
        ...
        name: "LAKSHMI-111",
        variety: "Hybrid Paddy",
        description: "High performance hybrid paddy with excellent grain quality and yield. Medium plant height with good tillering ability.",
        features: ["High Performance", "Good Tillering", "Disease Tolerant"],
        season: "Kharif",
        duration: "120-125 days",
      },
      {
        ...
        name: "MAHARAJA-222",
        variety: "Hybrid Paddy",
        description: "Premium hybrid paddy seed with bold grain quality. Strong plant structure with high yield potential and good disease resistance.",
        features: ["Bold Grains", "High Yield", "Strong Structure"],
        season: "Kharif",
        duration: "128-132 days",
      },
      {
        id: 11,
        name: "YUVRAJ-555",
        variety: "Hybrid Paddy",
        description: "High yield hybrid paddy with excellent adaptability. Medium plant height with strong tillers and good grain quality.",
        features: ["High Yield", "Wide Adaptability", "Strong Tillers"],
        season: "Kharif",
        duration: "125-130 days",
      },
    ],
  ...
  "research-paddy": {
    ...
    products: [
      ...
      },
      {
        ...
        name: "SAURAV-666",
        variety: "Improved Paddy",
        description: "High yielding improved paddy variety with excellent grain quality. Medium tall plant with strong stem and good tillering capacity.",
        features: ["High Yield", "Strong Stem", "All Soils"],
        season: "Kharif",
        duration: "130-135 days",
      },
      {
        id: 15,
        name: "DHANALAKSHMI-2255",
        variety: "Improved Paddy",
        description: "Premium improved paddy variety with excellent grain quality and high yield potential. Medium plant height with good disease tolerance.",
        features: ["Premium Quality", "High Yield", "Wide Adaptability"],
        season: "Kharif & Rabi",
        duration: "125-130 days",
      },
    ],
  ...
  vegetables: {
    ...
    products: [
      ...
      },
      {
        ...
        features: ["High Yield", "Dark Green Pods", "Good Quality"],
        season: "Kharif/Summer",
        duration: "45-50 days to first harvest",
      },
      {
        ...
        features: ["Premium Quality", "Tender Pods", "Good Branching"],
        season: "Kharif/Summer",
        duration: "45-48 days to first harvest",
      },
    ],
  ...
  bajra: {
    ...
    icon: Wheat,
    description: "Hybrid bajra seeds with high yield potential and excellent drought tolerance.",
    longDescription:
      "Vasudha Agri Seeds hybrid bajra (pearl millet) varieties are developed for high yield potential, excellent drought tolerance, and wide adaptability. Our bajra hybrids feature strong plant architecture with good grain quality suitable for diverse agro-climatic conditions.",
    image: "/images/slide-harvest.jpg",
    products: [
      {
        id: 1,
        ...
        description: "High yielding hybrid bajra with excellent drought tolerance. Strong plant structure with good grain filling and wide adaptability for diverse conditions.",
      ...
      },
      {
        ...
        name: "MAHENDRA-444",
        variety: "Hybrid Bajra",
        description: "Premium hybrid bajra with strong plant architecture and high grain yield. Excellent drought tolerance with bold grains and good disease resistance.",
        features: ["Premium Quality", "Bold Grains", "Drought Tolerant"],
        season: "Kharif",
        duration: "75-80 days",
      },
    ],
  ...
  wheat: {
    name: "Wheat",
    icon: Wheat,
    description: "Improved wheat seeds with high yield potential and excellent grain quality.",
    longDescription:
      "Vasudha Agri Seeds improved wheat varieties are developed for high yield potential, excellent grain quality, and wide adaptability. Our wheat seeds feature strong plant architecture with good disease tolerance suitable for Rabi season cultivation.",
    image: "/images/slide-harvest.jpg",
    products: [
      {
        id: 1,
        name: "DHARANI-666",
        variety: "Improved Wheat",
        description: "High yielding improved wheat variety with excellent grain quality. Strong plant structure with good tillering and disease tolerance.",
        features: ["High Yield", "Good Tillering", "Disease Tolerant"],
        season: "Rabi",
      ...
      },
      {
        ...
        name: "ARCHANA-555",
        variety: "Improved Wheat",
        description: "Premium improved wheat variety with strong plant architecture and high grain yield. Excellent adaptability with bold grains.",
        features: ["Premium Quality", "Bold Grains", "Wide Adaptability"],
        season: "Rabi",
  ...
  mustard: {
    name: "Mustard",
    icon: Sprout,
    description: "Hybrid mustard seeds with high oil content and excellent yield potential.",
    longDescription:
      "Vasudha Agri Seeds hybrid mustard varieties are developed for high oil content, excellent yield potential, and wide adaptability. Our mustard hybrids feature strong plant architecture with good disease tolerance suitable for Rabi season cultivation.",
    image: "/images/slide-harvest.jpg",
    products: [
      {
        id: 1,
        name: "RAKHI-555",
        variety: "Hybrid Mustard",
        description: "High yielding hybrid mustard with excellent oil content. Strong plant structure with good branching and wide adaptability.",
        features: ["High Yield", "High Oil Content", "Wide Adaptability"],
        season: "Rabi",
        duration: "110-120 days",
      },
      {
        ...
        name: "VIKRAM-999",
        variety: "Hybrid Mustard",
        description: "Premium hybrid mustard with strong plant architecture and high grain yield. Excellent oil content with bold seeds.",
        features: ["Premium Quality", "Bold Seeds", "High Oil Content"],
        season: "Rabi",
        duration: "105-115 days",
      },
    ],
